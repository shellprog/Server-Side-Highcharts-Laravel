...
(function () {
	...
	var config = {
			...
			files: { 
				JQUERY: 'public/charts/jquery.2.0.3.js',
				HIGHCHARTS: 'public/charts/highstock.js',
				HIGHCHARTS_MORE: 'public/charts/highcharts-more.js',
				HIGHCHARTS_DATA: 'public/charts/data.js',
				HIGHCHARTS_DRILLDOWN: 'public/charts/drilldown.js',
				HIGHCHARTS_FUNNEL: 'public/charts/funnel.js',
				HIGHCHARTS_HEATMAP: 'public/charts/heatmap.js',
				HIGHCHARTS_3D: 'public/charts/highcharts-3d.js',
				HIGHCHARTS_NODATA: 'public/charts/no-data-to-display.js',
				/*HIGHCHARTS_MAP: 'map.js',*/
				HIGHCHARTS_SOLID_GAUGE: 'public/charts/solid-gauge.js'
			},
